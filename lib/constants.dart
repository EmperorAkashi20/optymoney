...
const kPrimaryColor = Color(0xFFF77DD77);
...
const String kNoUserError1 = "Please Check your email or password";
const String kSignUp = "If you don't have an account, please sign up";
